    ...
    <div className="auth bg-cover bg-center h-screen" style={{backgroundImage: 'url(https://plus.unsplash.com/premium_photo-1677194562330-2210f33e2576?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGxvZ2lufGVufDB8fDB8fHww)'}}>
      <div className='auth-container '>
        <div className="btn-container ">
          <button disabled={!showCompanyLogin} onClick={()=> setShowCompanyLogin(!showCompanyLogin)} className={showCompanyLogin ? "btn btn-disable" : "btn btn-primary"}>User Login</button>
          <button disabled={showCompanyLogin} onClick={()=> setShowCompanyLogin(!showCompanyLogin)} className={showCompanyLogin ? "btn btn-primary" : "btn btn-disable"}>Company Login</button>
        </div>
